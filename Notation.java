...
public class Notation {
    ...
    public void replay(){
        ...
        JButton bReplay = new JButton("Play Best Replay");
        bReplay.addActionListener(new BestReplayListener());
        ...
        frame.add(BorderLayout.CENTER,bReplay);
    ...
    void getNameBestReplay(String name){
        tempReplayStr = name;
    }
    ...
    class BestReplayListener implements ActionListener {//слушатель кноки ВЫХОД
        public void actionPerformed(ActionEvent event) {
            if(tempReplayStr==""){
                SortHandler sort;
                sort = new SortHandler();
                sort.startSortNotation();
                tempReplayStr = sort.bestGame;
            }
            openReplay(tempReplayStr);
            frame.dispose();
        }
    }
